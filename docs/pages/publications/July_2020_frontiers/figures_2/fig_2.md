...
def display_Fig2 (data_structure, output_file_string="",
                            t_limits=[],dpi=300):
    # unit multipliers
    ...
    sarc_length_lim = [820,1060]        # in nano-meter
    ...
    #f.subplots_adjust(left=0.2, bottom=0.2, right=0.6, top=0.9)
    ...
    # add notation and arrow
    ax1.annotate(s='',xy=(x_start_arrow,y_start_arrow),
                xytext=(x_start_arrow+dxa,y_start_arrow+dya),
                arrowprops=dict(arrowstyle='<->'),
                annotation_clip=False,fontsize=15,fontweight='bold')
    ax1.annotate('Volume perturbation',xy=(x_start,y_start),
                xytext=(x_start+dx,y_start+dy),annotation_clip=False,fontsize=12)
    # other adjustments
...
if __name__ == "__main__":
    ...
    if (no_of_arguments == 1):
        ...
        display_Fig2(data,current_directory+'/'+'Fig_2.png',[0,17])
