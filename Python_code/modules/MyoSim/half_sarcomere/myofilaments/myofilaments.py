...
class myofilaments():
    ...
    def __init__(self, myofil_params, parent_half_sarcomere):
        ...
        if (self.kinetic_scheme == '4state_with_SRX'):
            ...
            self.k_4_0 = float(myofil_params.k_4_0.cdata)
            self.k_4_1 = float(myofil_params.k_4_1.cdata)
            self.k_5_0 = float(myofil_params.k_5_0.cdata)
            self.k_5_1 = float(myofil_params.k_5_1.cdata)
            self.k_6 = float(myofil_params.k_6.cdata)
            self.k_7_0 = float(myofil_params.k_7_0.cdata)
            self.k_7_1 = float(myofil_params.k_7_1.cdata)
            self.k_8 = float(myofil_params.k_8.cdata)
            self.k_cb = float(myofil_params.k_cb.cdata)
            self.x_ps = float(myofil_params.x_ps.cdata)
